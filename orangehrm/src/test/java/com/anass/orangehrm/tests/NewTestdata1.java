...
public class NewTestdata1 {
	
	public WebDriver driver;
	@DataProvider//(name="datadriven")
	public Object[][] DataforInvalidLogin()
	{
	...
	{
		String[][] credentials= {{"Admin","admin123"},{"Admin","admin123"},{"Admin","admin123"}};
		return credentials;
	}
...
//we can also use method name and do not give any name to DataProvider
	@Test(dataProvider="DataforInvalidLogin")
	//@Test(dataProvider="datadriven")
	public void InValidLogin1(String user,String pwd) throws InterruptedException
	{		
